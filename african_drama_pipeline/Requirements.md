# AfriDrama Pipeline — Requirements
...
- TrendResearcher: real social listening API client (configurable endpoint + API key)
- StoryWriter: real LLM client (OpenAI/Anthropic/Azure; configurable provider)
...
- VisualProducer: real image generation API
- VideoProducer: real video generation API
- AudioProducer: real TTS API
...
- Providers: LLM, image-gen, video-gen, TTS, trend API, OmniRoute
- Platforms: TikTok, YouTube, Instagram
- Video specs: 1080×1920, 9:16, 30fps, 60–120s

## 4. Out of Scope
- Real social listening API integration (use real endpoint if provided, otherwise config validation fails)
